        ...
        <div class="flex-container flexFlowColumn" style="gap: 8px; margin-bottom: 10px;">
          ...
          <div class="extension-mode-section" style="width: 100%; margin: 8px 0 0 0;">
            ...
            <div style="margin-top: 8px; display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
              <button type="button" id="btn-export-ext-manifest" class="menu_button menu_button_icon" style="padding: 6px 12px; font-size: 0.8rem; cursor: pointer;">
                <i class="fa-solid fa-file-export"></i> <span>仅导出扩展清单</span>
              </button>
              <small style="font-size: 0.74rem; opacity: 0.75;">
                只生成 JSON 清单（扩展名 / 安装 URL / 分支），<b>不含扩展代码</b>，不进包、不触发安装。
              </small>
            </div>
          </div>
